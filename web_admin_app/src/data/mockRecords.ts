...
export const mockRecords: MockRecord[] = [
  ...
  },
  {
    ...
    editFields: [
      ...
      { key: "authorization", label: "授權狀態", type: "select", value: "可查詢本人紀錄", options: ["可查詢本人紀錄", "尚未授權"], help: "用來標記此善信是否允許查詢本人相關紀錄。" },
  ...
  },
  {
    ...
    editFields: [
      ...
      { key: "authorization", label: "授權狀態", type: "select", value: "尚未授權", options: ["可查詢本人紀錄", "尚未授權"], help: "用來標記此善信是否允許查詢本人相關紀錄。" },
      { key: "handler", label: "資料維護人員", type: "select", value: "櫃檯人員 A", options: ["櫃檯人員 A", "值勤人員 A", "總幹事 A"], help: "由具備善信資料維護權限的團隊成員中選擇。" },
