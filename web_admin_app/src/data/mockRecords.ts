...
export const mockRecords: MockRecord[] = [
  ...
  },
  {
    ...
    editFields: [
      ...
      { key: "services", label: "發財金與服務紀錄", type: "tags", value: ["發財金領取", "還金提醒"], options: ["發財金領取", "發財金繳回", "平安龜", "還金提醒", "活動通知"] },
      { key: "authorization", label: "本人資料授權", type: "select", value: "已授權", options: ["待確認", "已授權", "未授權", "取消授權"], help: "確認本人相關紀錄查詢範圍。" },
      ...
      { key: "relations", label: "相關紀錄", type: "textarea", value: "發財金、還金提醒" },
  ...
  },
  {
    ...
    editFields: [
      ...
      { key: "authorization", label: "本人資料授權", type: "select", value: "未授權", options: ["待確認", "已授權", "未授權", "取消授權"], help: "確認本人相關紀錄查詢範圍。" },
      { key: "handler", label: "資料維護人員", type: "select", value: "櫃檯人員 A", options: ["櫃檯人員 A", "值勤人員 A", "總幹事 A"], help: "從可指派團隊成員中選擇。" },
