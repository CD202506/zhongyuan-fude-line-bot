...
class SQLiteRecordsRepository:
    def get_record_row(self, record_id: UUID) -> Any:
    ...
    def create_record(self, payload: RecordCreate) -> RecordResponse:
        ...
        record = row_to_record(self.get_record_row(record_id))
        self.create_audit_event(record_id, "create", payload.actor_role, payload.actor_name, None, record.model_dump(mode="json"))
        return record

    def get_record(self, record_id: UUID) -> RecordResponse:
        return row_to_record(self.get_record_row(record_id))

    def update_record(self, record_id: UUID, payload: RecordUpdate) -> RecordResponse:
        before = row_to_record(self.get_record_row(record_id))
        ...
        after = row_to_record(self.get_record_row(record_id))
        self.create_audit_event(record_id, "update", payload.actor_role, payload.actor_name, before.model_dump(mode="json"), after.model_dump(mode="json"))
        return after
    ...
    def archive_record(self, record_id: UUID, payload: ArchiveRequest | None = None) -> RecordResponse:
        ...
        after = row_to_record(self.get_record_row(record_id))
        self.create_audit_event(record_id, "archive", payload.actor_role, payload.actor_name, before.model_dump(mode="json"), after.model_dump(mode="json"))
        return after
    ...
    def restore_record(self, record_id: UUID, payload: RestoreRequest | None = None) -> RecordResponse:
        ...
        after = row_to_record(self.get_record_row(record_id))
        self.create_audit_event(record_id, "restore", payload.actor_role, payload.actor_name, before.model_dump(mode="json"), after.model_dump(mode="json"))
        return after
